...
# Trimmomatic_trimming_TruSeq3-PEadapters_from_SRX6608266
...
trimmomatic PE -phred33 $FOR $REV /path/trimmed/TruSeq3-PE/paired_SRR9853673_1.fq.gz /path/trimmed/TruSeq3-PE/unpaired_SRR9853673_1.fq.gz /path/trimmed/TruSeq3-PE/paired_SRR9853673_2.fq.gz /path/trimmed/TruSeq3-PE/unpaired_SRR9853673_2.fq.gz ILLUMINACLIP:/path/trimmomatic_adapters/adapters/TruSeq3-PE.fa:2:30:10:2:keepBothReads LEADING:20 TRAILING:20 MINLEN:36
